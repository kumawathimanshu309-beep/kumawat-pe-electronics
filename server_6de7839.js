...
// ΓöÇΓöÇ DATABASE CONNECTIVITY & SIMULATION FALLBACK ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
  ...
  app.post(['/api/coupon/validate', '/api/coupons/validate'], isAuthenticated, async (req, res) => {
    try {
      ...
      if (cartTotal < coupon.minOrderValue) {
        return res.json({ success: false, message: `Minimum order value of Γé╣${coupon.minOrderValue} required` });
      }
...
async function startServer() {
  ...
  try {
    ...
    server.listen(PORT, () => {
      ...
      logger.info(`≡ƒÜÇ Kumawat P&E Express Server running at http://localhost:${PORT}`);
    });
  } catch (err) {
...
// ΓöÇΓöÇ DATABASE SEEDERS ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
async function seedMongoDatabase() {
  try {
    ...
    if (!adminExists) {
      ...
      logger.info('Γ£ô Seeded MongoDB default admin account successfully.');
    }
  } catch (error) {
...
async function seedInMemoryDatabase() {
  ...
  logger.info('Γ£ô Seeded IN-MEMORY default admin account successfully.');
}

// ΓöÇΓöÇ EXPRESS MIDDLEWARES ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
app.use(helmet({
...
// ΓöÇΓöÇ CUSTOM CSRF VALIDATION MIDDLEWARE ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
// ΓöÇΓöÇ SECURITY AUTHENTICATION MIDDLEWARES ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
// ΓöÇΓöÇ PUBLIC PAGES ROUTES ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
// ΓöÇΓöÇ USER AUTHENTICATION CONTROLLERS ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
app.post('/auth/register', async (req, res) => {
  ...
  try {
    ...
    logger.info(`Γ£ô Registered User: ${name} (ID: ${userId})`);
...
// ΓöÇΓöÇ FORGOT PASSWORD / OTP VERIFICATION FLOW ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
app.post('/forgot-password/reset', async (req, res) => {
  ...
  try {
    ...
    res.render('login', {
      activePage: 'login',
      success: 'Γ£ô Password updated successfully! You can now login with your new credentials.',
      error: null
    });
...
// ΓöÇΓöÇ CUSTOMER DASHBOARD & CARDS ROUTING ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
// ΓöÇΓöÇ CHECKOUT & ORDER BOOKING SYSTEM ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
  ...
  try {
    ...
    if (isMongoConnected) {
      ...
      await User.updateOne(
        { userId: sessionUser.userId },
        {
          $push: { activities: { action: `Placed order ${orderId} total: Γé╣${safeTotalAmount}`, timestamp: new Date() } },
          $set: { cart: [] }
        }
      );
    } else {
      ...
      const user = mockDB.users.find(u => u.userId === sessionUser.userId);
      if (user) {
        user.activities.push({ action: `Placed order ${orderId} total: Γé╣${safeTotalAmount}`, timestamp: new Date() });
        user.cart = [];
      }
    }

    logger.info(`Γ£ô Order Created: ${orderId} (Confirmation Code: ${confirmationCode})`);
    
    io.emit('admin_notification', { type: 'new_order', message: `New Order Received! ID: ${orderId} Amount: Γé╣${totalAmount}` });
...
// ΓöÇΓöÇ ADDRESS & DELIVERY LOGIC ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
// Cart API
...
// ΓöÇΓöÇ ADMIN PANEL & MANAGEMENT ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
// ΓöÇΓöÇ ADMIN PORTAL LOGIC & DATA EXPORTS ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
// ΓöÇΓöÇ STORE MANAGEMENT ROUTES ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
// Public Store Page
...
// ΓöÇΓöÇ ERROR HANDLING MIDDLEWARES ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
